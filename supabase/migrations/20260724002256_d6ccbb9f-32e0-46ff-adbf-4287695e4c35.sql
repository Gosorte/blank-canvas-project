-- MIGRATION 20260408000819_69388db9-722e-4ba6-9657-f761d90c8f73.sql
...
-- MIGRATION 20260421222855_a2e8139c-c71d-40de-a0c1-770e72b96132.sql
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.produto_estoque_link TO authenticated;
GRANT ALL ON public.produto_estoque_link TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.notificacoes_pendentes TO authenticated;
GRANT ALL ON public.notificacoes_pendentes TO service_role;
