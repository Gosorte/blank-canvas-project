...
-- CRM Setores (departamentos de atendimento)
...
-- CRM Contatos (agenda de contatos do CRM)
...
-- CRM Conversas (chats de atendimento)
...
-- Operador write policies (for CRM daily operations)
