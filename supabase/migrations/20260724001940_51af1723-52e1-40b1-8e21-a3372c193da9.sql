-- MIGRATION 20260324000111_95b10958-b20e-4870-b201-dcf72ebd8595.sql
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.crm_avaliacoes TO authenticated;
GRANT ALL ON public.crm_avaliacoes TO service_role;

-- MIGRATION 20260324003101_777c2d7e-def0-4051-8d8e-d4f493c698de.sql
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.produtos_simples TO authenticated;
GRANT ALL ON public.produtos_simples TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.erp_orcamentos TO authenticated;
GRANT ALL ON public.erp_orcamentos TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.erp_orcamento_itens TO authenticated;
GRANT ALL ON public.erp_orcamento_itens TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.discount_authorizations TO authenticated;
